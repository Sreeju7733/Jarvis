...
window.onload = () => {
  ...
  // internet connectivity
    ...
    if(navigator.onLine){
      document.querySelector("#internet-on").style.display = "block"
      document.querySelector("#internet-of").style.display = "none"
      connectivity = "online"
    } else {
      document.querySelector("#internet-of").style.display = "block"
      document.querySelector("#internet-on").style.display = "none"
